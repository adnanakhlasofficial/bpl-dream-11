  ...
  return (
    <div className="bg-banner mt-6 flex min-h-[34rem] w-full flex-col items-center justify-center gap-6 rounded-3xl bg-cover text-center text-white">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="desc text-light-gray">Beyond Boundaries Beyond Limits</p>
      </div>
      <button onClick={claimCoin} className="btn ring-2 ring-primary ring-offset-8 ring-offset-deep-black">
        Claim Free Credit
      </button>
    </div>
  );
